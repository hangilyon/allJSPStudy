	...
	<c:if test="${sessionScope.id == null }">
		<nav>
		    <ul>
				...
				<li><a href="${contextPath }/login/login_view.jsp">LOGIN</a></li>
		    </ul>
		</nav>
	</c:if>
	<c:if test="${sessionScope.id != null }">
		<nav>
		    <ul>
				<li><a href="${contextPath }/default/main.jsp">HOME</a></li>
				<li><a href="${contextPath }/member/member_view.jsp">MEMBER SHIP</a></li>
				<li><a href="${contextPath }/board/board_view.jsp">BOARD</a></li>
